...
class HCamera2Manager2 {
    private static final String TAG = "HCamera2Manager2";

    private static HCamera2Manager2 ins;
    ...
    public static HCamera2Manager2 getInstance() {
        if (ins == null) {
            synchronized (HCamera2Manager2.class) {
                if (ins == null) {
                    ins = new HCamera2Manager2();
                }
            }
        }
        return ins;
