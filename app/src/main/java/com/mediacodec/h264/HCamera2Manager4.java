...
class HCamera2Manager4 {
    private static final String TAG = "HCamera2Manager4";

    private static HCamera2Manager4 ins;
    ...
    public static HCamera2Manager4 getInstance() {
        if (ins == null) {
            synchronized (HCamera2Manager4.class) {
                if (ins == null) {
                    ins = new HCamera2Manager4();
                }
            }
        }
        return ins;
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                ...
                for (String cameraId : cameraIdList) {
                    if (Objects.equals(cameraId, Integer.toString(mStartCameraId+3))) {
