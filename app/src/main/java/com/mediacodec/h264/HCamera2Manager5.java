...
class HCamera2Manager5 {
    private static final String TAG = "HCamera2Manager5";

    private static HCamera2Manager5 ins;
    ...
    public static HCamera2Manager5 getInstance() {
        if (ins == null) {
            synchronized (HCamera2Manager5.class) {
                if (ins == null) {
                    ins = new HCamera2Manager5();
                }
            }
        }
        return ins;
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                ...
                for (String cameraId : cameraIdList) {
                    if (Objects.equals(cameraId, Integer.toString(mStartCameraId+4))) {
