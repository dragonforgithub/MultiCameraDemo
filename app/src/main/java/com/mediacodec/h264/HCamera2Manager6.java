...
class HCamera2Manager6 {
    private static final String TAG = "HCamera2Manager6";

    private static HCamera2Manager6 ins;
    ...
    public static HCamera2Manager6 getInstance() {
        if (ins == null) {
            synchronized (HCamera2Manager6.class) {
                if (ins == null) {
                    ins = new HCamera2Manager6();
                }
            }
        }
        return ins;
